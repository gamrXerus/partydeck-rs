...
Clone the repo with submodules by running `git clone --recurse-submodules https://github.com/gamrXerus/partydeck-rs`. Navigate to the gamescope submodule at `deps/gamescope` and run these commands to build the mouse/keyboard gamescope:
